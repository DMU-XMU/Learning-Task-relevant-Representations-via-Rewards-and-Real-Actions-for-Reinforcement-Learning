...
class CRESP(AUXBase):
    ...
    def __init__(self, action_shape, extr_latent_dim, nstep_of_rsd, hidden_dim,
                 ...
                 extr_beta, action_limit, omega_opt_mode=None, num_sample=256, discount_of_rs=0.8,
                 temperature=0.1, opt_mode='min', opt_num=5, decoder_weight_lambda=0.0, device='cpu', **kwargs):
        super().__init__()
    ...
    def update_extr(self, data, aug_s, aug_s2, num_aug):
